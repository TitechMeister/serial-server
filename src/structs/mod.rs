...
impl UltrasonicData {
    fn new(id: u8, timestamp: u32, altitude: f32, temperature: f32, received_time: i64) -> Self {
...
impl BarometerData {
    fn new(id: u8, timestamp: u32, pressure: f32, temperature: f32, received_time: i64) -> Self {
        BarometerData {
